...
func TestMulrshiftcodeOperation(t *testing.T) {
	tests := []struct {
		code []byte
		x, y int64
		want int64
	}{
		{[]byte{0xA9, 0xB4, 0x03}, 9, 2, 1},
		{[]byte{0xA9, 0xB4, 0x03}, -9, 2, -2},
		{[]byte{0xA9, 0xB4, 0x03}, 0, 2, 0},
		{[]byte{0xA9, 0xB4, 0x03}, -5634879008887978, 2, -704359876110998},
		{[]byte{0xA9, 0xB4, 0x03}, 11, 2, 1},
		{[]byte{0xA9, 0xB4, 0x03}, -11, 2, -2},
	}
