...
func TestModpow2rcodeOperation(t *testing.T) {
	tests := []struct {
		code []byte
		x    int64
		want int64
	}{
		{[]byte{0xA9, 0x39, 0x02}, 10, 2},
		{[]byte{0xA9, 0x39, 0x03}, 10, -6},
		{[]byte{0xA9, 0x39, 0x02}, 5, -3},
		{[]byte{0xA9, 0x39, 0x02}, -7, 1},
		{[]byte{0xA9, 0x39, 0x03}, 0, 0},
		{[]byte{0xA9, 0x39, 0x21}, -5634879008887978, -2175620266},
		{[]byte{0xA9, 0x39, 0x02}, -5634879008887978, -2},
		{[]byte{0xA9, 0x39, 0x01}, -7, 1},
		{[]byte{0xA9, 0x39, 0x01}, -13, -1},
	}
	...
	for _, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if err != nil {
				t.Fatal("Failed MODPOW2R# pop: ", err.Error())
			}
