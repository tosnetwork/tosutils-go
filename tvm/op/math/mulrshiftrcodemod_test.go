...
func TestMulrshiftrcodemodOperation(t *testing.T) {
	tests := []struct {
		code []byte
		x, y int64
		q, r int64
	}{
		{[]byte{0xA9, 0xBD, 0x03}, 9, 2, 1, 2},
		{[]byte{0xA9, 0xBD, 0x03}, -9, 2, -1, -2},
		{[]byte{0xA9, 0xBD, 0x03}, 0, 2, 0, 0},
		{[]byte{0xA9, 0xBD, 0x03}, -5634879008887978, 2, -704359876110997, -4},
		{[]byte{0xA9, 0xBD, 0x03}, 11, 2, 1, 6},
		{[]byte{0xA9, 0xBD, 0x03}, -11, 2, -1, -6},
	}
	...
	for _, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if err != nil {
				t.Fatal("Failed MULRSHIFTR#MOD execution:", err.Error())
			}
