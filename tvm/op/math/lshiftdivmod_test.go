...
func TestLshiftdivmodOperation(t *testing.T) {
	tests := []struct {
		x, y, z int64
		q, r    int64
	}{
		...
		{5, 3, 40, 1832519379626, 2},
		{5, 40, 3, 1, 0},
		{1, 3, 0, 0, 1},
		{-5634879008887978, 37867867, 2, -595214831, 21183565},
	}
	...
	for _, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if err != nil {
				t.Fatal("Failed LSHIFTDIVMOD execution:", err.Error())
			}
